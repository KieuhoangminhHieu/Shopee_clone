...
public enum ErrorCode {
    ...
    CARTITEM_NOT_FOUND(1101, "Cart item not found", HttpStatus.NOT_FOUND),
    CARTITEM_QUANTITY_INVALID(1102, "Cart item quantity must be greater than 0", HttpStatus.BAD_REQUEST),
